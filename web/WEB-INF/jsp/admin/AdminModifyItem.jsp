...
<div class="logincontainer">
    <section id="logincontent">
        <form action="adminmodifyitem" method="post">
            <h1>修改物品</h1>
            <div>
                物品编号:&nbsp&nbsp<input type="text" name="itemId" id="username" value="${sessionScope.ModifyItem.itemId}"readonly><br/>
            </div>
            <div>
                物品名称:&nbsp&nbsp<input type="text" name="itemName" id="username" value="${sessionScope.ModifyItem.itemName}"required=""><br/>
            </div>
            <div>
                物品价格:&nbsp&nbsp<input type="text" name="itemPrice" id="username" value="${sessionScope.ModifyItem.price}" required=""><br/>
            </div>
            <div>
                物品简介:&nbsp&nbsp<input type="text" name="itemDescn" id="username"  value="${sessionScope.ModifyItem.descn}" required=""><br/>
            </div>
            <div>
                物品库存:&nbsp&nbsp<input type="text" name="itemNumber"id="username"  value="${sessionScope.ModifyItem.itemNumber}" required=""><br/>
            </div>
