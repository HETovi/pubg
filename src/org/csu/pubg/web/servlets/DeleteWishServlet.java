 ...
 */
@WebServlet(name = "DeleteWishServlet")
public class DeleteWishServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        int deleteWishItem= Integer.parseInt(request.getParameter("deleteWishItem"));
        if(wishService.deleteWish(username,deleteWishItem)){
